const AudioManager = (() => {
  ...
  const musicThemes = {
    ...
    arcade:    { label:'🕹️ Arcade',   tempo:320, wave:'square',   pattern:[[523,659,784],[587,740,880],[659,784,988],[784,988,1175]],                                         bass:[131,147,165,196] },
    focus:     { label:'🎯 Focus',    tempo:950, wave:'sine',     pattern:[[262,330,392],[247,330,392],[220,294,370],[196,262,330]],                                          bass:[65,62,55,49] },
    adventure: { label:'🗺️ Adventure',tempo:560, wave:'triangle', pattern:[[196,392,523],[220,440,587],[247,494,659],[262,523,784]],                                          bass:[65,73,82,87] },
